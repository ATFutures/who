...
<div class="figure" style="text-align: center">
<img src="fig/accra-osm-overview.png" alt="Overview of OSM data in Accra." width="70%" />
<p class="caption">(\#fig:unnamed-chunk-4)Overview of OSM data in Accra.</p>
</div>
...
<p class="caption">(\#fig:compareKat)Improved representation of Kathmandu on OpenStreetMap after KLL efforts. Source: KLL, 2018.</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)The OSM map of Kathmandu, with 2km x 2km grids placed at the centre of each municipality.</p>
</div>
