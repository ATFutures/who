...
<p class="caption">(\#fig:unnamed-chunk-2)The mini buses at a terminal loading passengers</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-3)Accra bicycle masterplan (Quarshie, 2007)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-4)Congestion in Kathmandu. Source: Cover photo from Udas (CEN), 2012; photo by Keshav Thapa (CEN)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Capacity and fleet of the different public transport vehicle types in Kathmandu Valley (2010). Source: Table 2 from Udas (CEN), 2012 (originally KSUT Project Report)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)Morning peak hours vehicle type occupancy in Kathmandu Valley (2010). Source: Fig. 15 from Udas (CEN), 2012 (originally KSUT Project Report)</p>
</div>
<div class="figure">
...
<p class="caption">(\#fig:unnamed-chunk-9)Evening peak hours vehicle type occupancy in Kathmandu Valley (2010). Source: Fig. 16 from Udas (CEN), 2012 (originally KSUT Project Report)</p>
</div>
-->
...
<div class="figure">
<img src="fig/KathmanduPlansCycleMap_smaller.png" alt="Left: Planned (brown), being constructed (red) and existing (green) cycle tracks as of December 2013. Source: Fig. 12 CEN, 2013c, background Google Maps. Right: OpenStreetMap Cycle Map and Google Aerial for Kathmandu Metropolitan City. Legend: Existing cycle tracks (blue) according to OSM. Source: openstreetmap.org." width="100%" />
<p class="caption">(\#fig:katcycle)Left: Planned (brown), being constructed (red) and existing (green) cycle tracks as of December 2013. Source: Fig. 12 CEN, 2013c, background Google Maps. Right: OpenStreetMap Cycle Map and Google Aerial for Kathmandu Metropolitan City. Legend: Existing cycle tracks (blue) according to OSM. Source: openstreetmap.org.</p>
</div>
...
Table: (\#tab:unnamed-chunk-10)Basic OSM characteristics of case study cities
...
Table: (\#tab:unnamed-chunk-11)Characteristics of OSM route network data for case study cities.
...
<p class="caption">(\#fig:unnamed-chunk-12)Overview of Accra (left) and initial results of cycling potential (right).</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-13)Improved representation of Kathmandu on OpenStreetMap after KLL efforts. Source: KLL, 2018.</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-14)The OSM map of Kathmandu, with 2km x 2km grids placed at the centre of each municipality.</p>
</div>
