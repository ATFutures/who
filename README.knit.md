...
<p class="caption">(\#fig:unnamed-chunk-4)Overview of Accra (left) and initial results of cycling potential (right).</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Improved representation of Kathmandu on OpenStreetMap after KLL efforts. Source: KLL, 2018.</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)The OSM map of Kathmandu, with 2km x 2km grids placed at the centre of each municipality.</p>
</div>
