...
The same strategy of drawing 2km x 2km grids at the central of each administrative sub-division (called municipality) is employed. We also The distibution of the grids is also seen to provide a good cross-section of the street network across Kathmandu. Here, we classified the municipalities into two, namely; (1) urban and (2) semi-urban municipalities. This classification is also based on spatial extent of the road network across each municipality, roughly estimated from the satellite image through visual inspection. Thus, we have 51-100% and 0-50% coverages as urban and semi-urban municipalities, respectively.
