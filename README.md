...
A systematic visual inspection was carried out so as to assess both the positional accuracy and the completeness of the current OSM datasets covering the GAMA. This was accomplished by placing a 2km by 2km grid at the geometrical centre of each district (Fig.). From our observations, these grids provide a good cross-section of the street network across GAMA, from the high population density district of Accra metropolitan to the low population density of Shai Osudoku. We classified the districts into three, namely (1) urban district, (2) semi-urban district and (3) rural districts. This classification is based on whether the road infrastructures (roughly estimated from the satellite image) have spatial coverage between 51-100%, 25-50%, or 0-25% of their respective district. In other words, we use road infrastructure as a proxy for urbanisation. These are colored in pink, yellow and blue grids, respectively. The urban districts, such as Ga Central Municipal and Accra Metropolis, are characterised by very dense street networks, while the semi-urban districts such as Ga West Municipal and Ga South Municipal districs, do also contain dense street network, but around the areas that are adjacent to urban districts. The four eastern-most districts contained the least road coverage, which include only trunk roads connect GAMA to the other regions of the country.

<img src="fig/quality grid_osm_accra.png" alt="The OSM map of GAMA, with 2km x 2km grids placed at the geometrical centre of each district." width="100%" />
<p class="caption">
The OSM map of GAMA, with 2km x 2km grids placed at the geometrical centre of each district.
</p>
