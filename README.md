...
1.  The OSM map of Bristol, with 2km x 2km grids placed at the centre of each administrative ward, and (b) the 2km x 2km grid at the centre of Bishopston administrative ward
    ...
    Fig. xx (b) is the 2km x 2km grid at the central of a randomly selected administrative ward - Bishopston. It can be observed that the OSM dataset has a very high positional accuracy based on the alignment....... across all the districts. The road segments are well-aligned and properly contained within the width of their respective raster representation.
