...
values of 1.3 and 13.7km, indicating that 63% (1-exp(-1)) of all pedestrian
trips are 1.3km or less, while the same proportion of cycling trips are less
than 13.7km. Both of these models generated using the above procedure were very
significantly related to the actual OD matrices, with the pedestrian model
reproducing 38.4% of the structure of the observed OD matrix, while the cycling
model reproduced less than 10% of the equivalent structure.

This value of 13.7km for cyclists likely reflects a small proportion of very
active cyclists who commute relatively very long distances between home and
work. (Add more here ...)
