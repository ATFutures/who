...
# Preliminary results: cycling potential
...
```{r calibbris, fig.cap="Estimated cycling potential on the route network in Bristol."}
knitr::include_graphics("fig/flows-calib-bris.png")
```
...
In autumn 2017 we developed a plan for the development of a toolkit for transport planning, a 'Active Travel Futures Toolkit'.
...
An outline of this plan is provided below:
