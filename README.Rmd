...
```{r, fig.cap="Ga West Municipal and Ashaiman Municipal districts (left and right, respectively) – two semi-urban districts. The oval shapes indicate areas where streets are missing."}
