...
```{r sevnet, fig.cap="The core cycling network in Seville (which has mean monthly summer temperatures of up to 28.2 °C), composed of the 'basic' (77 km) and 'complementary' (120 km) protected cylce path network [@marques_how_2015]."}
# (120 + 77) * 100 / 700
knitr::include_graphics("fig/sevnet.png")
```
